...
const TopNav = () => {
    return (
        <nav className="w-full h-16 fixed shadow-md z-10 bg-white top-0">
            <ul className="h-full flex flex-row">
                <li className="flex items-center justify-center w-1/6 cursor-pointer"><h1><Link className="text-gray-900 text-[28px] font-normal" href="/">NP Checklist</Link></h1></li>
