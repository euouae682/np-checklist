    ...
    return (
        <div className="bg-white shadow-lg rounded-3xl grid grid-cols-5 grid-rows-2 py-4">
            ...
            <div className="col-span-2 flex p-4 gap-16">
                <button onClick={ props.handleStatsClick } className="bg-button-blue hover:bg-button-blue-hover rounded-full text-white py-2 px-8 transition">Show Stats</button>
